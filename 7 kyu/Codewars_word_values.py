# -*- coding: utf-8 -*-
"""
Created on Fri Oct  2 14:12:34 2020
...
# will have a value of 1 + 2 + 3 = 6.
# This means that: a = 1, b = 2, c = 3 ....z = 26.

# You will be given a list of strings and your 
# task will be to return the values of the strings 
# as explained above multiplied by the position of
...
def name_value(my_list):
    ...
    z = []
    z.append(u[0])
    for x in list(range(1,len(u))):
        z.append(u[x] * (x+1))
    
    return z

print(name_value(["abc","abcd"]))